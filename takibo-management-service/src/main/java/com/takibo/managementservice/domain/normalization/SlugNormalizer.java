...
public final class SlugNormalizer {
    ...
    private static final Pattern LEADING_HYPHEN = Pattern.compile("^-");
    ...
    public static String normalize(String rawValue) {
        return Optional.ofNullable(rawValue)
                ...
                .map(value -> LEADING_HYPHEN.matcher(value).replaceFirst(""))
                .map(value -> TRAILING_HYPHEN.matcher(value).replaceFirst(""))
                .orElse("");
    }
}
