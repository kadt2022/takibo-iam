...
| [TMS-OAUTH-CLIENT-BOUNDARY-01](TMS-OAUTH-CLIENT-BOUNDARY-01.md) | Aligner le registre OAuth sur les frontières PLATFORM / ORGANIZATION / SPACE | à faire |
...
| Récit | Titre | Statut |
| --- | --- | --- |
| [TAKIBO-INSTALL-KEYS-01](../terminer/TAKIBO-INSTALL-KEYS-01-bootstrap-cryptographique-portable.md) | Bootstrap cryptographique portable | **TERMINÉ** (PR #60, 2026-09-02) |
